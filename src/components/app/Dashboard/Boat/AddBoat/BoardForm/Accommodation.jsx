...
const Accommodation = ({
  ...
  return (
    <>
      ...
      {/* <div className="mb-4">
                <label htmlFor="accommodationTitle" className="block text-sm font-medium text-gray-700">
                     Title.
                </label>
                <input
                    type="text"
                    id="accommodationTitle"
                    name="title"
      ...
      <form onSubmit={goToNextStep}>
        {/* <div className="my-4">
          <h4 className="block mb-2 text-xl font-noraml text-gray-900">
            Accommodation Image {" "}
          ...
          {boardData?.accommodation?.Picture && (
            <img
              width={120}
              className="mt-5"
              src={boardData?.accommodation?.Picture}
            />
          )}
        </div> */}
        {/*Updated Code */}
                ...
                <label className="flex gap-4 w-full items-center px-4 py-2 bg-white text-blue rounded-lg border tracking-wide uppercase cursor-pointer">
                  ...
                  <span className="mt-2 text-base leading-normal">
                    {boardData?.accommodation?.Picture ? "Change Image" : "Select a file"}
                  </span>
                  <input
                    type="file"
                    className="hidden"
                    accept=".jpg,.png,.jpeg,.webp"
                    name="Picture"
                    required={!boardData?.accommodation?.Picture}
                    onChange={(e) => handleAccommodationChange(e)}
                  />
                </label>
