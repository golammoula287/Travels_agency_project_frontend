...
//     // Clear the featured image from boardData
//     handleImageChanges("featuredImage", null);
//   };
...
//             Add Carousel Images (Please add a minimum of 5, and a maximum of 15 at a 2:3 image ratio)
//             </h2>
        ...
        <div>
          ...
          {/*Update Version */}
                  ...
                  <label className="flex gap-4 w-full items-center px-4 py-2 bg-white text-blue rounded-lg border tracking-wide uppercase cursor-pointer">
                    ...
                    <span className="mt-2 text-base leading-normal">
                      {boardData?.featuredImage ? "Change Image" : "Select a file"}
                    </span>
                    <input
                      type="file"
                      className="hidden"
                      accept=".png,.jpg"
                      name="featureImage"
                      required={!boardData?.featuredImage}
                      onChange={(e) =>
                        handleImageChanges("featuredImage", e.target.files[0])
                      }
                    />
