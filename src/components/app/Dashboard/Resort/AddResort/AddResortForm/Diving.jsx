...
const Diving = ({
    ...
    <>
      ...
      <form onSubmit={goToNextStep}>
        <div className="my-4">
         ...
         {/*Updated Version With Remove Button */}
         {/* <div className="my-4">
  <h4 className="block mb-2 text-xl font-normal text-gray-900">
    Diving Image{" "}
    <span className="font-normal">
  ...
  {resortData?.diving?.image && (
    <div className="mt-5 w-fit relative">
      ...
      <button
        onClick={() => handleDivingChange({ target: { name: "image", files: [null] } })}
        type="button"
        className="absolute top-0 right-0 bg-green-500 text-white rounded-full flex justify-center items-center cursor-pointer p-1"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
