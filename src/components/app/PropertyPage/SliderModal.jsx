...
<div className="swiper-container" style={{ position: 'absolute', bottom: 0, left: 0, right: 0 }}>
  <Swiper
    navigation={true}
    modules={[Navigation]}
    initialSlide={initialSlide}
  ...
  >
    ...
    {propertyData?.featureImage && (
      <SwiperSlide
        onClick={() => openHandler(propertyData.featureImage)}
        key="featureImage"
      >
        <div className="aspect-w-3 aspect-h-2">
          <img
            className="h-full w-full cursor-pointer object-cover"
            src={propertyData.featureImage}
          />
        </div>
      </SwiperSlide>
    )}
